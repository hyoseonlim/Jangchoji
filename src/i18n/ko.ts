...
export const ko = {
  ...
  meta: {
    ...
    description:
      "대기 없는 가평 빠지! 펜션과 빠지 3초 거리, 직영펜션·수상레저·수상스키·바베큐 올인원 패키지",
  ...
  pricing: {
    ...
    hours: {
      title: "빠지 수상레저 운영시간",
      lines: [
        "성수기(7월 17일 ~ 8월 17일): 09:00 – 18:00",
        "성수기 점심시간: 13:00 – 14:00",
        "비수기 평일: 10:00 – 18:00",
        "비수기 주말: 09:00 – 18:00",
      ],
  ...
  footer: {
    ...
    postalPrefix: "우편번호",
    hoursTitle: "운영 시간",
    hoursWeekday: "성수기 7/17 – 8/17 09:00 – 18:00",
    hoursWeekend: "비수기 평일 10:00 – 18:00",
    hoursPeak: "비수기 주말 09:00 – 18:00",
    reserve: "예약하기 →",
    businessLabel: "상호:",
    ownerLabel: "대표:",
