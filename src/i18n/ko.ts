...
export const ko = {
    ...
    packages: {
      ...
      rows: {
        peak: {
          ...
          "2": [
            { config: "숙박 + 놀이기구 3종", weekday: 95000, saturday: 105000 },
            { config: "숙박 + 놀이기구 5종", weekday: 110000, saturday: 120000 },
            { config: "숙박 + 놀이기구 오전무제한", weekday: 120000, saturday: 130000 },
            { config: "숙박 + 놀이기구 오후무제한", weekday: 130000, saturday: 140000 },
            { config: "숙박 + 놀이기구 종일무제한", weekday: 140000, saturday: 150000 },
            { config: "숙박 + 놀이기구 3종 + BBQ", weekday: 124000, saturday: 134000 },
            { config: "숙박 + 놀이기구 5종 + BBQ", weekday: 139000, saturday: 149000 },
            { config: "숙박 + 놀이기구 오전무제한 + BBQ", weekday: 149000, saturday: 159000 },
            { config: "숙박 + 놀이기구 오후무제한 + BBQ", weekday: 159000, saturday: 169000 },
            { config: "숙박 + 놀이기구 종일무제한 + BBQ", weekday: 169000, saturday: 179000 },
          ],
        },
        off: {
          "4": [
  ...
  safety: {
    ...
    features: [
      ...
      },
      {
        ...
        title: "응급 안전 시스템",
        description:
          "구급대원 자격을 갖춘 스태프가 현장에 상주합니다. AED(자동심장충격기)와 응급처치 장비를 완비하고 있으며, 가평 병원과 비상 연락 체계를 갖추고 있습니다.",
      },
      {
        icon: "🌊",
        title: "안전한 수역 확보",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "네, 조은마트 연계 픽업 서비스를 운영합니다. 굴봉산역에서 조은마트 픽업차량이 픽업 → 조은마트 장보기 → 건전한 레저까지 이동, 귀가 시에도 픽업이 가능합니다. 이용 조건은 1인 기준 최소 15,000원 이상 장보기이며, 예를 들어 4명이면 최소 50,000원 이상 장보기 시 왕복 픽업이 가능합니다. 소인원부터 단체까지 모두 이용 가능합니다.",
      },
      {
        id: "bbq",
  ...
  directions: {
    ...
    pickup: {
      title: "조은마트 픽업 서비스",
      subtitle: "굴봉산역 하차 후 조은마트 연계 픽업으로 편하게 오실 수 있습니다.",
      steps: [
        "굴봉산역 하차",
        "조은마트 픽업차량 픽업",
        "조은마트에서 장보기",
      ...
      conditionPre: "1인 기준 최소 ",
      conditionStrong1: "15,000원 이상 장보기",
      conditionMid: " · 예를 들어 4명이면 ",
      conditionStrong2: "최소 50,000원 이상",
      conditionPost: " 장보기 시 왕복 픽업 가능 (소인원~단체 모두 이용 가능).",
      conditionExtra:
        "조은마트는 가평 소재 대형마트로 고기·주류·스낵·냉동냉장·일회용품 등을 구매하실 수 있습니다. 예약 후 픽업 요청을 남겨주시면 연결해 드립니다.",
    },
    phoneLabel: "전화 문의 / 예약",
