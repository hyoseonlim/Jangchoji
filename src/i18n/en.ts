...
export const en: Dictionary = {
  ...
  pricing: {
    ...
    hours: {
      ...
      lines: [
        "Peak season (Jul 17 – Aug 17): 09:00 – 18:00",
        "Peak-season lunch break: 13:00 – 14:00",
        "Off-season weekdays: 10:00 – 18:00",
        "Off-season weekends: 09:00 – 18:00",
      ],
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Yes, we run a pickup service in partnership with Joeun Mart. From Gapyeong Station, board the Joeun Mart shuttle → shop at the mart → shuttle to Water leisure, and we also pick you up on your way back to Gapyeong Station. The only condition is a minimum of ₩15,000 in groceries per person, and parties of any size — from small groups to large ones — are welcome.",
      },
      {
        id: "bbq",
  ...
  directions: {
    ...
    pickup: {
      ...
      subtitle: "Travel comfortably from Gapyeong Station through Joeun Mart to Water leisure — round-trip pickup included.",
      steps: [
        "Arrive at Gapyeong Station and board the mart pickup shuttle",
        "Shop at Joeun Mart",
        "Shuttle to Water leisure",
        "Round-trip pickup back to Gapyeong Station",
      ],
      conditionTitle: "Conditions",
      conditionPre: "A minimum of ",
      conditionStrong1: "₩15,000 in groceries per person",
      conditionMid: " qualifies you for pickup. The shuttle waits while you shop and ",
      conditionStrong2: "picks you back up on your way home",
      conditionPost: " (parties of any size — small to large — are welcome).",
      conditionExtra:
        "Joeun Mart is a large supermarket in Gapyeong stocking meat, drinks, snacks, refrigerated/frozen goods, disposables, and more at reasonable prices. Just leave a pickup request after booking and we'll connect you.",
    },
  ...
  footer: {
    ...
    hoursTitle: "Hours",
    hoursWeekday: "Peak season Jul 17 – Aug 17 09:00 – 18:00",
    hoursWeekend: "Off-season weekdays 10:00 – 18:00",
    hoursPeak: "Off-season weekends 09:00 – 18:00",
    reserve: "Reserve →",
