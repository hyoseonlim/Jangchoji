...
export const en: Dictionary = {
  ...
  nav: {
    ...
    reserve: "Reserve",
    reserveMobile: "Reserve on Naver",
    menuOpen: "Open menu",
  ...
  hero: {
    ...
    activitiesItems: [
      { text: "Water Play Rides", href: "#rides" },
  ...
  pricing: {
    ...
    packages: {
      ...
      groupSizeLabels: { "4": "4 guests", "2-3": "2–3 guests" },
      ...
      notes: {
        ...
        under4: "Additional fee applies for parties under 4",
      },
      bbqComposition: "Meat · rice · sausage · kimchi · ssamjang · ssammu · king oyster mushroom · disposables",
      rows: {
        peak: {
          "4": [
  ...
  detailPages: {
    ...
    items: {
      ...
      stay: {
        ...
        intro:
          "A cozy night in the Gapyeong outdoors. Choose from 4- to 8-guest rooms. The 5-, 6-, and 8-guest rooms include a loft, so extra guests can join.",
        prices: [],
        info: [
          "4-guest room: no loft · up to 4 guests",
          "5-guest room: loft included · up to 6 guests",
          "6-guest room: loft included · up to 8 guests",
          "8-guest room: loft included · up to 10 guests",
        ],
        rooms: [
          { key: "stay4", title: "4-guest room", desc: "No loft · up to 4 guests" },
          { key: "stay5", title: "5-guest room", desc: "Loft · up to 6 guests" },
          { key: "stay6", title: "6-guest room", desc: "Loft · up to 8 guests" },
          { key: "stay8", title: "8-guest room", desc: "Loft · up to 10 guests" },
        ],
        amenities: {
