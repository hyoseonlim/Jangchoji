  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Unlimited BBQ includes meat, rice, ssamjang, ssammu, kimchi, sausage, dried radish, and disposables. Add the BBQ option to any stay package to enjoy it.",
      },
      {
        id: "peak-season",
